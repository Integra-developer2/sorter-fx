...
public class objReadBarcode {
    ...
    public ArrayList<String> readBarCodes(String path, String bcType) {
        ...
        try{
            ProcessBuilder pb = new ProcessBuilder("wsl","/srv/scandit_multiple/"+objGlobals.scanditProgram,"/srv/scandit_multiple/"+objGlobals.scanditKey,"/srv/scandit_multiple/codes_"+bcType+".settings",wslPath);
    ...
    public ArrayList<String>readLine(String line,  ArrayList<String>ret){
        ...
        if(!m.isEmpty()){
            String barcode = barcodeClean(m.getFirst());
    ...
    public void logGrayResults(String code){
